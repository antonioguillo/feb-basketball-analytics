"""Trabajos de scraping: descarga de partidos individuales, ligas y el histórico
completo, más la actualización recurrente de la temporada en curso.

`main.py` es solo el CLI que llama a estas funciones; aquí vive la lógica.
"""
import json
import os
import re
...
from src import COMPETITIONS, FEBBasketballScraper
...
CACHE_ENLACES = Path(__file__).parent.parent / "data" / "cache_enlaces.json"
